...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Movie.author":
		if e.complexity.Movie.Author == nil {
			break
		}

		return e.complexity.Movie.Author(childComplexity), true
...
var sources = []*ast.Source{
	&ast.Source{Name: "graph/schema.graphqls", Input: `type Movie{
  id: ID!
  title: String!
  url: String!
  author: Director!
...
func (ec *executionContext) field_Mutation_createMovie_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalNNewMovie2edwardlieᚑgraphqlᚑserverᚋgraphᚋmodelᚐNewMovie(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Movie_author(ctx context.Context, field graphql.CollectedField, obj *model.Movie) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	fc.Result = res
	return ec.marshalNDirector2ᚖedwardlieᚑgraphqlᚑserverᚋgraphᚋmodelᚐDirector(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_createMovie(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMovie2ᚖedwardlieᚑgraphqlᚑserverᚋgraphᚋmodelᚐMovie(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_movies(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Movie)
	fc.Result = res
	return ec.marshalNMovie2ᚕᚖedwardlieᚑgraphqlᚑserverᚋgraphᚋmodelᚐMovieᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewMovie(ctx context.Context, obj interface{}) (model.NewMovie, error) {
	...
	for k, v := range asMap {
		...
		case "directorId":
			var err error
			it.DirectorID, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) _Movie(ctx context.Context, sel ast.SelectionSet, obj *model.Movie) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "author":
			out.Values[i] = ec._Movie_author(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) marshalNDirector2edwardlieᚑgraphqlᚑserverᚋgraphᚋmodelᚐDirector(ctx context.Context, sel ast.SelectionSet, v model.Director) graphql.Marshaler {
	return ec._Director(ctx, sel, &v)
}

func (ec *executionContext) marshalNDirector2ᚖedwardlieᚑgraphqlᚑserverᚋgraphᚋmodelᚐDirector(ctx context.Context, sel ast.SelectionSet, v *model.Director) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalNMovie2edwardlieᚑgraphqlᚑserverᚋgraphᚋmodelᚐMovie(ctx context.Context, sel ast.SelectionSet, v model.Movie) graphql.Marshaler {
	return ec._Movie(ctx, sel, &v)
}

func (ec *executionContext) marshalNMovie2ᚕᚖedwardlieᚑgraphqlᚑserverᚋgraphᚋmodelᚐMovieᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Movie) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMovie2ᚖedwardlieᚑgraphqlᚑserverᚋgraphᚋmodelᚐMovie(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMovie2ᚖedwardlieᚑgraphqlᚑserverᚋgraphᚋmodelᚐMovie(ctx context.Context, sel ast.SelectionSet, v *model.Movie) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNNewMovie2edwardlieᚑgraphqlᚑserverᚋgraphᚋmodelᚐNewMovie(ctx context.Context, v interface{}) (model.NewMovie, error) {
